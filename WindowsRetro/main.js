...
function about(){
    ...
    $("div.about_window").append('<div class="about_content" id="style-4"></div>');
    ...
    $("div.about_content").append('<div class="winTLimg_aux" style="display:grid; place-items:center"></div>');
    $("div.winTLimg_aux").append('<button type="button" class="btn btn-secondary showTL" onclick="showTL()">Click to show Windows Time Line</button>');
    isShowed = true;
}

function showTL(){
    $("button.showTL").remove();
    $("div.winTLimg_aux").append('<img class="winTLimg" src="https://www.xda-developers.com/files/2021/10/Windows-version-history-4.jpg" alt="Windows Timeline"</img>');
}